...
// --- Simple data (edit to your needs) ---
const NAV = [
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 grid lg:grid-cols-2 items-center gap-10">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a href="#courses"><Button className="rounded-2xl px-6 py-6 text-base">Выбрать курс</Button></a>
              <a href="#lead"><Button variant="outline" className="rounded-2xl px-6 py-6 text-base">Получить консультацию</Button></a>
            </div>
            ...
            {COURSES.map((c, idx) => (
              <Card key={idx} className="rounded-2xl overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  ...
                  <div className="mt-4">
                    <Button className="w-full rounded-xl">Подробнее</Button>
                  </div>
                </CardContent>
              </Card>
            ))}
          ...
          <Card className="rounded-2xl bg-white text-slate-900">
            ...
            <CardContent>
              <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); alert("Спасибо! Мы свяжемся с вами в ближайшее время."); }}>
                ...
                <Button type="submit" className="w-full rounded-xl">Отправить</Button>
